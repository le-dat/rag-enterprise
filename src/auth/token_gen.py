...
def main() -> None:
    ...
    parser.add_argument("--role", required=True, choices=[r.value for r in Role], help="User RBAC Role level")
    parser.add_argument("--department", required=True, choices=[d.value for d in Department], help="User RBAC Department")
